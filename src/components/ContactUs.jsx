...
const ContactUs = () => {
    ...
    formData.append("access_key", "5edb04cf-22e1-47ed-b1d4-6c9c9d0cc3a0");
        ...
        <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
            ...
            <form onSubmit={onSubmit} className='grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full'>
                ...
                <div className='sm:col-span-2'>
                    ...
                    <textarea name="message" rows={8} placeholder='Enter your messages' className='w-full p-3 text-sm outline-none rounded-lg border border-gray-300 dark:border-gray-600' required />
                </div>
